...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SolarSynth", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("SolarSynth", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "SolarSynth";
		app.meta["name"] = "Solar Synth";
		app.meta["packageName"] = "com.example.myapp";
		app.meta["version"] = "V1.0.0-420";
